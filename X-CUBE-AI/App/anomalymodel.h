/**
  ...
  ******************************************************************************
  */
#ifndef AI_ANOMALYMODEL_H
#define AI_ANOMALYMODEL_H

#include "anomalymodel_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_ANOMALYMODEL_MODEL_NAME          "anomalymodel"
#define AI_ANOMALYMODEL_ORIGIN_MODEL_NAME   "lightanomaly2"

/******************************************************************************/
#define AI_ANOMALYMODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ANOMALYMODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_ANOMALYMODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_ANOMALYMODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_ANOMALYMODEL_IN \
  ai_anomalymodel_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ANOMALYMODEL_IN_SIZE { \
  AI_ANOMALYMODEL_IN_1_SIZE, \
}
#define AI_ANOMALYMODEL_IN_SIZE_BYTES { \
  AI_ANOMALYMODEL_IN_1_SIZE_BYTES, \
}
#define AI_ANOMALYMODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ANOMALYMODEL_IN_1_CHANNEL     (64)
#define AI_ANOMALYMODEL_IN_1_SIZE        (64)
#define AI_ANOMALYMODEL_IN_1_SIZE_BYTES  (256)

/******************************************************************************/
#define AI_ANOMALYMODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ANOMALYMODEL_OUT \
  ai_anomalymodel_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ANOMALYMODEL_OUT_SIZE { \
  AI_ANOMALYMODEL_OUT_1_SIZE, \
}
#define AI_ANOMALYMODEL_OUT_SIZE_BYTES { \
  AI_ANOMALYMODEL_OUT_1_SIZE_BYTES, \
}
#define AI_ANOMALYMODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ANOMALYMODEL_OUT_1_CHANNEL     (64)
#define AI_ANOMALYMODEL_OUT_1_SIZE        (64)
#define AI_ANOMALYMODEL_OUT_1_SIZE_BYTES  (256)

/******************************************************************************/
#define AI_ANOMALYMODEL_N_NODES (4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup anomalymodel
 ...
 * @ref ai_anomalymodel_create. Both the activations memory buffer 
 ...
 * using @ref ai_anomalymodel_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_anomalymodel_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_anomalymodel_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_ANOMALYMODEL_*
 * defines into file @ref anomalymodel.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_anomalymodel_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_ANOMALYMODEL_H */
